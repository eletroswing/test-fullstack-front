          ...
          {data.cities.map((city: any) => {
            return (
              <Link
                ...
                href={`/public/${routeParams.state}/${city.city_id}`}
    ...
    <main className="w-full pb-20 px-6 overflow-x-hidden">
      <header className="w-full">
        <div className=" w-full flex justify-center flex-col items-center">
          <h1 className="font-bold text-2xl px-8 pt-10">Select your city.</h1>
        </div>
      </header>
      ...
      <nav aria-label="Breadcrumb" className="w-full mb-8 mt-4">
        <div className="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 w-fit">
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <a className="inline-flex cursor-pointer items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                <svg
